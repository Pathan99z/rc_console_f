    ...
    <div class="flex-1 flex items-center justify-center px-4 py-12">
      <AuthCard>
        <div class="rc-auth-content rc-auth-grid">
          ...
          <h1 class="rc-auth-title text-center">Forgot password?</h1>
          <p class="rc-auth-subtitle text-center">Enter your email and we'll send you a reset link.</p>

          <AuthAlert v-if="auth.apiMessage" :variant="sent ? 'success' : 'error'" :message="auth.apiMessage" />
